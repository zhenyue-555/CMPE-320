...
void play() {
        ...
        while (window_play.isOpen()) {
            ...
            if (player.HP > 0) {
                ...
                if (enemySpawnTimer >= 25) {
                    int a = rand() % 3;
                    if (a == 0) {
                        enemies.push_back(Enemy(&enemyTex1, window_play.getSize()));
                    }
                    else if (a == 1) {
                        enemies.push_back(Enemy(&enemyTex2, window_play.getSize()));
                    }
                    //one more
                    else {
                        enemies.push_back(Enemy(&enemyTex3, window_play.getSize()));
                    }
    ...
    if (page_number == 1) {
        RenderWindow window_tutorial(VideoMode(780, 550), "Tutorial", Style::Default);
    ...
    if (page_number == 2) {
        ...
        while (window_leaderboard.isOpen()) {
            ...
            scoretext3.setCharacterSize(50);
